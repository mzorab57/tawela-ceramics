  ...
  return (
    <section name="hero" className="section text-white h-screen">
      <div className="relative overflow-hidden bg-transparent flex h-screen">
        ...
        <div className="w-24 h-screen hidden lg:block border border-b-0 bg-transparent absolute left-0 border-gray-500 z-10">
          <ul className="size-full flex flex-col justify-center gap-y-32">
            <li className="hover:text-orange-300 -rotate-90 cursor-pointer">
              <Link to="https://www.facebook.com/share/19pAjXfhq5/">
                INSTAGRAM
              </Link>
            </li>
            <li className="hover:text-orange-300 -rotate-90">
              <Link to="https://www.instagram.com/tawela_ceramics?igsh=MWV3cnoxazJieGd5aw==">
                FACEBOOK
              </Link>
            </li>
            <li className="hover:text-orange-300 -rotate-90">
              <Link to="https://www.tiktok.com/@tawela.ceramic?fbclid=PAY2xjawIODxNleHRuA2FlbQIxMQABpqIjyzjP8V9LH-E1ZZvbjzWSaHFA5Moo0ppmW6p-hDjeodaFhbYuVNxypg_aem_X61Lm_VqawVpY93bE00m6g">
                TIKTOK
              </Link>
            </li>
          </ul>
        ...
        {/* Centered content */}
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white space-y-6 px-4 min-h-screen">
          ...
          <AnimatedComponent animationType="fade-up" dataAosDuration="1000">
            <div className="flex space-x-4 border border-gray-400">
              ...
              <button className="hover:bg-gray-100 text-gray-400 lg:px-6 px-2 lg:py-3 py-1.5 whitespace-nowrap font-jost text-lg flex items-center space-x-2">
                <LinkScroll to="contacts" smooth={true} duration={500}>
                  Get in Touch
                </LinkScroll>
                <span>→</span>
              </button>
